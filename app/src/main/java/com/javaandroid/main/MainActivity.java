    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SnackbarUtil.ShortSnackbar(constraintLayout,"你好",1).show();
            }
        });
        ...
        button_example_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TSnackbar.make(constraintLayout, "Hello from VSnackBar 1", TSnackbar.LENGTH_LONG).show();
            }
        });
        ...
        button_example_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TSnackbar snackbar = TSnackbar.make(constraintLayout, "Had a snack at Snackbar", TSnackbar.LENGTH_LONG)
        ...
        button_example_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TSnackbar snackbar = TSnackbar
                        .make(constraintLayout, "Had a snack at Snackbar", TSnackbar.LENGTH_LONG)
        ...
        button_example_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TSnackbar snackbar = TSnackbar
                        .make(constraintLayout, "Had a snack at Snackbar  Had a snack at Snackbar  Had a snack at Snackbar Had a snack at Snackbar Had a snack at Snackbar Had a snack at Snackbar", TSnackbar.LENGTH_LONG);
                snackbar.setActionTextColor(Color.WHITE);
                View snackbarView = snackbar.getView();
        ...
        button_example_5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TSnackbar snackbar = TSnackbar
                        .make(constraintLayout, "Snacking with VectorDrawable", TSnackbar.LENGTH_LONG);
                snackbar.setActionTextColor(Color.WHITE);
        ...
        button_example_6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TSnackbar snackbar = TSnackbar
                        .make(constraintLayout, "Snacking Left & Right", TSnackbar.LENGTH_LONG);
                snackbar.setActionTextColor(Color.WHITE);
